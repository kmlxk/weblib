...
<body>
  ...
  <div class="container">
    <div class="navbar-header">
      ...
      <a href="<?php echo Yii::app()->request->baseUrl; ?>/../libs/bootstrap3-doc/v3.bootcss.com/" class="navbar-brand">Bootstrap</a>
    </div>
    <nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
      <ul class="nav navbar-nav">
        <li class="active">
          <a href="<?php echo Yii::app()->request->baseUrl; ?>/../libs/bootstrap3-doc/v3.bootcss.com/getting-started">起步</a>
        </li>
        <li>
...
<div class="container" id="page">
	...
	<div id="footer">
		Copyright &copy; <?php echo date('Y'); ?> by test.<br/>
